...
export default function TeamLandingPage() {
  return (
    <div className="flex flex-col min-h-screen text-white bg-[#0E1013]">
      ...
      <section className="relative py-20 md:py-32 px-4 md:px-8 bg-gradient-to-b from-orange-900/20 to-[#0E1013] border-b border-white/10">
        <div className="max-w-5xl mx-auto text-center">
          <div className="flex justify-center mb-4 md:mb-6">
            <Users size={60} className="text-orange-400 md:w-20 md:h-20" strokeWidth={1.5} />
          </div>
          ...
          <Link
            to="/landing"
            className="inline-block bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold transition-all shadow-lg"
          >
      ...
      <section className="py-12 md:py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">Built for Team Success</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {[
              ...
              return (
                <div key={i} className="bg-white/5 rounded-2xl p-4 md:p-6 border border-white/10 hover:border-orange-500/50 transition-all">
      ...
      <section className="py-12 md:py-16 px-4 md:px-8 bg-white/5 border-y border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl md:text-3xl font-bold mb-4">Bring Your Team Together</h3>
