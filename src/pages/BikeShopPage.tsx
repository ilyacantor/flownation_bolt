        ...
        <div className="max-w-7xl mx-auto px-6">
          <section className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              Find your equipment anywhere in any shop at any time
            </p>
          </section>
              ...
              {filteredShops.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {filteredShops.map((shop) => (
                    <div
                      key={shop.id}
                      className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-cyan-400/50 transition-all group"
                    >
          ...
          {!hasSearched && (
            <section className="text-center py-12">
              <p className="text-gray-400 text-lg">
                Enter your search criteria above to find bike shops in your area
              </p>
            </section>
          )}
        </div>
